...
with tab4:
    ...
    st.markdown("""
    <div style="background-color: #f0f7f7; border-left: 4px solid #0D3B3C; padding: 12px 16px; margin-bottom: 16px; border-radius: 0 8px 8px 0;">
Understanding microplastics toxicity doesn't require starting from scratch. By identifying research in adjacent fields that studies the same biological mechanisms, you can discover established methods, model systems, and expert collaborators whose work directly informs microplastics research. Select a mechanism and chemical field below to explore relevant NIH-funded grants.
        <br><br>
